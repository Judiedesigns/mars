import svgPaths from "./svg-cq181jvxo1";
...
export default function Overlay() {
  return (
    <div className="bg-[#648cd6] overflow-clip relative rounded-[8px] size-full" data-name="overlay">
      <div className="absolute content-stretch flex flex-col gap-[82px] items-end left-[40px] top-[202px] w-[601.388px]" data-name="image and year">
      ...
      <div className="absolute content-stretch flex flex-col gap-[427px] items-start left-[711px] top-[90px] w-[503px]" data-name="title/livelink">
        ...
        <div className="content-stretch flex flex-col gap-[8px] h-[48px] items-start relative shrink-0">
          ...
          <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
            <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0.98)] border-b border-solid inset-0 pointer-events-none" />
